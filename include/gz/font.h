...
public:
    ...
    static void renderChars(const char* str, float x, float y, u32 color,
                            float size = FONT_DEFAULT_SIZE);
    static void GZ_drawChar(char c, float x, float y, u32 color, bool drop_shawdows,
                            float size = FONT_DEFAULT_SIZE);
...
inline void GZ_drawText(const char* str, float x, float y, u32 color, bool shadows) {
